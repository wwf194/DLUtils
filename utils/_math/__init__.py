...
GaussianCoefficient = 1.0 / (2 * math.pi) ** 0.5
...
if TYPE_CHECKING:
    ...
    sklearn = DLUtils.LazyImport("sklearn")
    PCAsklearn = DLUtils.LazyFromImport("sklearn.decomposition", "PCA")
...
if TYPE_CHECKING:
    ...
    torch = DLUtils.LazyImport("torch")
    sklearn = DLUtils.LazyImport("sklearn")
